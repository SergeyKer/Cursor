...
const MODE_KEY = 'engvo_vocab_tts_rotation_mode'
const SHUFFLE_KEY = 'engvo_vocab_tts_shuffle_remaining'

function canUseStorage(): boolean {
  return typeof window !== 'undefined' && typeof window.localStorage !== 'undefined'
}

export function getVocabTtsRotationModePref(): EngvoXaiVoiceRotationMode {
...
export function setVocabTtsRotationModePref(value: EngvoXaiVoiceRotationMode): void {
...
export function getVocabTtsShuffleRemaining(): EngvoXaiVoice[] {
  if (!canUseStorage()) return []
  try {
...
export function setVocabTtsShuffleRemaining(value: readonly EngvoXaiVoice[]): void {
  if (!canUseStorage()) return
  try {
...
export function clearVocabTtsShuffleRemaining(): void {
