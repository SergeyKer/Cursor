...
import { buildFinaleTimelineStep, getLessonLearningSteps, normalizeFinaleBubbleContent, resolveLessonFinale } from '@/lib/lessonFinale'
...
describe('lessonFinale helpers', () => {
  ...
  it('builds a render-only completion step for the timeline', () => {
    ...
    expect(timelineStep.bubbles[0]?.content).toContain('Урок завершён.')
