import type { CefrLevelConfig, SupportedCefrLevel } from '@/lib/cefr/cefrDefaults'
...
export type CefrLevelConfigGetter = (level: LevelId) => CefrLevelConfig | null

export function createCefrSpecApi(getCefrLevelConfig: CefrLevelConfigGetter) {
  function getCefrSpec(level: LevelId): CefrLevelSpec | null {
  ...
  function getCefrDenyWords(params: { level: LevelId; audience: Audience }): Set<string> {
  ...
  function buildCefrPromptBlock(params: {
    level: LevelId
    audience: Audience
