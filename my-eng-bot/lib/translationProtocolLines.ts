...
/** `Комментарий_перевод` и устаревший `Комментарий_ошибка` — перед `Комментарий`, иначе регекс съест префикс. */
export const TRANSLATION_PROTOCOL_BLOCK_NAMES =
  'Комментарий_ошибка|Комментарий_перевод|Комментарий|Ошибки|Время|Конструкция|Формы|Скажи|Повтори|Repeat|Say'
