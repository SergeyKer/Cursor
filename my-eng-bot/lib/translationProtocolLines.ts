...
/** Имена блоков в формате «Имя: …». `Комментарий_перевод` — перед `Комментарий`, иначе регекс съест префикс. */
export const TRANSLATION_PROTOCOL_BLOCK_NAMES =
  'Комментарий_перевод|Комментарий|Ошибки|Скажи|Повтори|Repeat|Say'
