...
const SECTIONS = {
  child: {
    ...
    starByCommunication: dailyStarLabel('Звезда дня: общение'),
    starByTranslation: dailyStarLabel('Звезда дня: перевод'),
    starByDialogue: dailyStarLabel('Звезда дня: диалог'),
    starByEngvo: dailyStarLabel('Звезда дня: звонок'),
    starByPractice: dailyStarLabel('Звезда дня: практика'),
    starByLesson: dailyStarLabel('Звезда дня: урок'),
    starByLegacy: dailyStarLabel('Звезда дня'),
