...
export const TUTOR_CHAT_COPY = {
  ...
  closeTitle: 'Закрыть',
  closeBackToReferenceAriaLabel: 'Назад в справочник',
  closeBackToReferenceTitle: 'Назад в справочник',
  chipReturnReference: 'К справочнику',
  ...
  cheatsheetGenerateFailed:
    'Не удалось собрать шпаргалку по ответу. Попробуй ещё раз или уточни тему в поле.',
