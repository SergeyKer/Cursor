...
const THEORY_TAGS: TheoryTag[] = [
  ...
  },
  {
    ...
    order: 10,
    menuLabelRu: 'Формальный it — It’s / It’s time to',
    menuLabelEn: "Formal it · It's time to",
    title: "It's time to",
  ...
  },
  {
    ...
    order: 10,
    menuLabelRu: 'Вопросы с Who (особый порядок слов)',
  ...
  },
  {
    ...
    categoryId: 'questions',
    order: 20,
    menuLabelRu: 'Who — вопрос к подлежащему',
  ...
  },
  {
    ...
    focusLine: 'I know what … · пересказ и встраивание',
  },
  {
    id: 'word-order',
    categoryId: 'sentence_structure',
